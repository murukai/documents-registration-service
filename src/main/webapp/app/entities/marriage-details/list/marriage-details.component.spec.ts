...
describe('Component Tests', () => {
  describe('MarriageDetails Management Component', () => {
    let comp: MarriageDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MarriageDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.marriageDetails?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
