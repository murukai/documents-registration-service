...
describe('Component Tests', () => {
  describe('NextOfKeen Management Component', () => {
    let comp: NextOfKeenComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NextOfKeenComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nextOfKeens?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
