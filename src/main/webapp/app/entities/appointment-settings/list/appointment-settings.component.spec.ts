...
describe('Component Tests', () => {
  describe('AppointmentSettings Management Component', () => {
    let comp: AppointmentSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppointmentSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.appointmentSettings?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
