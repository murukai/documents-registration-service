...
class AddressResourceIT {
     ...
     *
     * @see com.afrikatek.documentsregistrationservice.repository.search.AddressSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Address createEntity(EntityManager em) {
        ...
        // Add required entity
        address.setCountryOfBirth(country);
        // Add required entity
        address.setCountryOfResidence(country);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getPlaceOfBirth()).isEqualTo(DEFAULT_PLACE_OF_BIRTH);
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getPlaceOfBirth()).isEqualTo(UPDATED_PLACE_OF_BIRTH);

        // Validate the Address in Elasticsearch
        verify(mockAddressSearchRepository).save(testAddress);
    }
